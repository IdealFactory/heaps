...
class SkinTangent extends SkinBase {
	...
	static var SRC = {
		...
		function vertex() {
			...
			transformedPosition *= flip.mat3x4();
			transformedNormal = normalize(transformedNormal); // * flip.mat3x4();
			transformedTangent.xyz = normalize(transformedTangent.xyz); // * flip.mat3x4();
		}
